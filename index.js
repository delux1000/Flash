...
const BIN_ID = "6994c9b743b1c97be986b84b";
const MASTER_KEY = "$2a$10$UFKAyDvpR8RhJ8QzH2Q3zuDyayu0LAVb9OVIhHZyhmxTaZInpfrTu";
...
async function loadState() {
  try {
    ...
    if (response.status === 404) {
      // Bin doesn't exist, create initial state
      const initial = {
        chainId: CHAIN_ID,
...
// Start server
app.listen(8545, () => {
  console.log("✅ Mainnet RPC Simulator running on port 8545");
  console.log("   Chain ID: 1 (0x1), Network ID: 1");
  console.log("   Real mainnet tokens: USDC, DAI, WETH, USDT");
  console.log("   Using jsonbin.io for storage (Bin ID: 6994c9b743b1c97be986b84b)");
});
